...
export HADOOP_LOG_DIR=/home/user/hadoop/hadoopsingle/log/$USER

# Where log files are stored in the secure data environment.
export HADOOP_SECURE_DN_LOG_DIR=/home/user/hadoop/hadoopsingle/log/

# The directory where pid files are stored. /tmp by default.
export HADOOP_PID_DIR=/home/user/hadoop/hadoopsingle/run/hadoop
export HADOOP_SECURE_DN_PID_DIR=/home/user/hadoop/hadoopsingle/run/hadoop
