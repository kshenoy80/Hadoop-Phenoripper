...
echo !MPIEXEC! -noprompt -delegate -l -exitcodes -genvlist %GENVLIST% -hosts %HOST_COUNT% %LSB_MCPU_HOSTS% !MATLAB_CMD! 
call !MPIEXEC! -noprompt -delegate -l -exitcodes -genvlist %GENVLIST% -hosts %HOST_COUNT% %LSB_MCPU_HOSTS% !MATLAB_CMD! 
